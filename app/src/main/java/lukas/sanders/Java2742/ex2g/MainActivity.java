...
public class MainActivity extends ComponentActivity {
    ...
    private void loadSensorReadings() {
        String url = "http://204.77.50.53/propertymonitor/api/sensorreadings/4044";
        ...
        this.httpClient.get(MainActivity.this, url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                SensorReadingAdapter sensorReadingAdapter = new SensorReadingAdapter(MainActivity.this, R.layout.sensor_reading_recycler_item, sensorReadings);
